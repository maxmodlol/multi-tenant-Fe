          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="mb-8">
              ...
              <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-300 leading-relaxed max-w-2xl mx-auto mb-4">
                حدث خطأ غير متوقع في أحد مكونات التطبيق. يرجى المحاولة مرة أخرى.
              </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
              ...
              >
                <RefreshCw className="w-5 h-5 ml-2 group-hover:rotate-12 transition-transform duration-300" />
                إعادة تحميل الصفحة
              </Button>
            </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 text-right">
                <div className="space-y-3">
                  ...
                  <ul className="text-sm text-gray-600 dark:text-gray-400 space-y-2">
                    <li>• اضغط على "المحاولة مرة أخرى"</li>
