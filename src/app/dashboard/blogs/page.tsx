...
import { useApproveBlog, useDeclineBlog, useDeleteBlog } from "@explore/lib/useBlogMutations";
import { useDashboardBlogs } from "@explore/lib/useDashboardBlogs";
...
export default function BlogsPage() {
  ...
  const { data, isError, isLoading } = useDashboardBlogs({
    ...
    statuses: statusFilter === "all" ? undefined : [statusFilter as BlogStatus],
  });
  const categories =
    data?.blogs
